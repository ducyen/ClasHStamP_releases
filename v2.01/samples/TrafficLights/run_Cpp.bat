...
SET SYNTAX_INTERFACE=%TOOL_DIR%\Syntax_HppAbs.csv
SET SYNTAX_ABSTRACT=%TOOL_DIR%\Syntax_HppAbs.csv
SET SYNTAX_BASECLASS=%TOOL_DIR%\Syntax_Hpp.csv
...
SET SYNTAX=%TOOL_DIR%\Syntax_Cpp.csv
SET SYNTAX_INTERFACE=%TOOL_DIR%\Syntax_Cpp.csv
SET SYNTAX_ABSTRACT=%TOOL_DIR%\Syntax_Cpp.csv
SET SYNTAX_BASECLASS=%TOOL_DIR%\Syntax_Cpp.csv
